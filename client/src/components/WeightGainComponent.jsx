  ...
  return (
    <div className="space-y-5">
      <motion.div
        ...
        className="rounded-2xl border border-orange-400/25 bg-gradient-to-br from-orange-500/10 to-amber-500/10 p-5 sm:p-6"
      >
        <div className="flex items-start gap-4">
          <div className="text-3xl sm:text-4xl">💪</div>
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-bold text-orange-500 mb-1">Weight Gain Mode</h3>
            <p className="text-sm nb-muted leading-relaxed">
              Focus on building muscle mass with a calorie surplus and high protein intake.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="rounded-xl bg-orange-500/15 border border-orange-400/25 p-4">
            <p className="text-xs text-orange-500/90 mb-1">Calories</p>
            <p className="text-2xl font-bold text-orange-500">{calorieGoal}</p>
          ...
          <div className="rounded-xl bg-blue-500/15 border border-blue-400/25 p-4">
            ...
            <p className="text-xs nb-muted mt-1">for muscle</p>
          </div>
          ...
          <div className="rounded-xl bg-pink-500/15 border border-pink-400/25 p-4">
            ...
            <p className="text-xs nb-muted mt-1">hormones</p>
          </div>
        </div>
      </motion.div>
    </div>
