  ...
  return (
    <div className="space-y-5">
      <motion.div
        ...
        className="rounded-2xl border border-red-400/25 bg-gradient-to-br from-red-500/10 to-pink-500/10 p-5 sm:p-6"
      >
        <div className="flex items-start gap-4">
          <div className="text-3xl sm:text-4xl">🔥</div>
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-bold text-red-500 mb-1">Weight Loss Mode</h3>
            <p className="text-sm nb-muted leading-relaxed">
              Focus on sustainable weight loss with a healthy calorie deficit and high protein intake.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="rounded-xl bg-red-500/15 border border-red-400/25 p-4">
            <p className="text-xs text-red-500/90 mb-1">Calories</p>
            <p className="text-2xl font-bold text-red-500">{calorieGoal}</p>
