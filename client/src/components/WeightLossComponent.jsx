...
/**
 * WeightLossComponent - Specialized component for users with a weight loss goal
 * Shows nutrition recommendations focused on calorie deficit and healthy metabolism
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-red-500/10 to-pink-500/10 border border-red-400/30 rounded-2xl p-6"
      >
        <div className="flex items-start gap-4">
          <div className="text-4xl">🔥</div>
          <div className="flex-1">
            <h3 className="text-xl font-bold text-red-600 mb-1">Weight Loss Mode</h3>
            <p className="text-sm">Focus on sustainable weight loss with a healthy calorie deficit and high protein intake.</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-red-500/20 rounded-lg p-4 border border-red-400/30">
            <p className="text-xs text-red-300 mb-1">Calories</p>
            <p className="text-2xl font-bold text-red-400">{calorieGoal}</p>
            <p className="text-xs text-red-200 mt-1">kcal/day</p>
          </div>
